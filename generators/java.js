 ...
 * @author guizos@gmail.com (Jorge Blasco)
 */
'use strict';
...
Blockly.Java.addReservedWords(
	...
	// Main Classes names
	'String,System,Integer,Double,Byte,Char,StringBuffer,Scanner,File'+
	// litelars and other stuff
...
Blockly.Java.ORDER_FUNCTION_CALL = 1;  // ()
Blockly.Java.ORDER_INCREMENT = 1;      // ++
Blockly.Java.ORDER_DECREMENT = 1;      // --
Blockly.Java.ORDER_LOGICAL_NOT = 2;    // !
Blockly.Java.ORDER_BITWISE_NOT = 2;    // ~
Blockly.Java.ORDER_UNARY_PLUS = 2;     // +
Blockly.Java.ORDER_UNARY_NEGATION = 2; // -
Blockly.Java.ORDER_NEW = 3;            // new
Blockly.Java.ORDER_MULTIPLICATION = 4; // *
Blockly.Java.ORDER_DIVISION = 4;       // /
Blockly.Java.ORDER_MODULUS = 4;        // %
Blockly.Java.ORDER_ADDITION = 5;       // +
Blockly.Java.ORDER_SUBTRACTION = 5;    // -
Blockly.Java.ORDER_BITWISE_SHIFT = 6;  // << >> >>>
Blockly.Java.ORDER_RELATIONAL = 7;     // < <= > >=
Blockly.Java.ORDER_INSTANCEOF = 7;     // instanceof
Blockly.Java.ORDER_EQUALITY = 8;       // == != === !==
Blockly.Java.ORDER_BITWISE_AND = 9;   // &
Blockly.Java.ORDER_BITWISE_XOR = 10;   // ^
Blockly.Java.ORDER_BITWISE_OR = 11;    // |
Blockly.Java.ORDER_LOGICAL_AND = 12;   // &&
Blockly.Java.ORDER_LOGICAL_OR = 13;    // ||
Blockly.Java.ORDER_CONDITIONAL = 14;   // ?:
Blockly.Java.ORDER_ASSIGNMENT = 15;    // = += -= *= /= %= <<= >>= ...
Blockly.Java.ORDER_COMMA = 16;         // ,
...
Blockly.Java.init = function() {
  ...
  //Commented to avoid bad initializations. Should be changed for advanced initializations
