...
Blockly.Css.CONTENT = [
  ...
  '.blocklyDraggable {',
    ...
    */
  '  cursor: url(<<<PATH>>>/asset/handopen.cur) 8 5, auto;',
  '}',
  ...
  */
  ...
  '  background: url(<<<PATH>>>/asset/sprites.png) no-repeat -48px -16px !important;',
  '}',
  ...
  '  background-image: url(<<<PATH>>>/asset/sprites.png);',
  '}',
