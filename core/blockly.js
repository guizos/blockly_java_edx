...
goog.require('Blockly.FieldVariableInteger');
goog.require('Blockly.FieldVariableString');
goog.require('Blockly.FieldVariableBoolean');
...
Blockly.setCursorHand_ = function(closed) {
  ...
  var cursor = '';
  if (closed) {
    cursor = 'url(' + Blockly.pathToBlockly + 'asset/handclosed.cur) 7 3, auto';
  }
  if (Blockly.selected) {
